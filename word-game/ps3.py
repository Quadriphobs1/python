...
def get_word_score(word, n):
    ...
    word_length_calculations = 7 * len(word) - 3 * (n - len(word))
    word_length_score = max(word_length_calculations, 1)
    return word_score * word_length_score
